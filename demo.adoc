...
----
+
TIP: If you'd rather not create a JWT decoder bean, you can use the https://github.com/okta/okta-spring-boot[Okta Spring Boot starter], which has built-in audience validation.
